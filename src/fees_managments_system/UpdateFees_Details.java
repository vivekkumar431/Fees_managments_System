...
public class UpdateFees_Details extends javax.swing.JFrame {
    public UpdateFees_Details() {
        initComponents();
        displayCashFirst();
        fillComboBox();
   ...
   SetRecord();
    ...
    public void SetRecord(){
        try{
           ...
           if(db.rst.next()){
           txt_Receipt.setText(db.rst.getString("receipt_no"));
           String PaymentMode=db.rst.getString("payment_mode");
           Combo_paymentMode.setSelectedItem(PaymentMode);
                txt_ddNo.setText(db.rst.getString("dd_no"));
                txt_chequeno.setText(db.rst.getString("cheque_no"));
                txt_bankName.setText(db.rst.getString("bank_no"));
              dateChooser.setDate(db.rst.getDate("date"));
               txt_ReceivedForm1.setText(db.rst.getString("student_name"));
               Combo_course.setSelectedItem(db.rst.getString("course_name"));
              txt_GSTNo.setText(db.rst.getString("gstin"));
                txt_year1.setText(db.rst.getString("year1"));
                  txt_year2.setText(db.rst.getString("year2"));
                     txt_couseName.setText(db.rst.getString("course_name"));
                      txt_amount.setText(db.rst.getString("amount"));
                        txt_cgst.setText(db.rst.getString("cgst"));
                          txt_sgst.setText(db.rst.getString("sgst"));
                            txt_total.setText(db.rst.getString("total_amount"));
                              txt_mark.setText(db.rst.getString("total_in_words"));
                              txt_RollNo.setText(db.rst.getString("roll_no"));
                              txt_Remark.setText(db.rst.getString("remark"));
           }
        }
    ...
    int receiptno=Integer.parseInt(txt_Receipt.getText());
     ...
     try{
         DBCON db=new DBCON();
         db.pstmt=db.con.prepareStatement("update fees_details set  student_name=?,roll_no=?,payment_mode=?,cheque_no=?,bank_no=?,"
                 + " dd_no = ?,course_name=?,gstin=?,total_amount=?,date=?,amount=?,cgst=?,sgst=?,total_in_words=?,remark=?,year1=?,year2=? where  receipt_no=?");
        
         db.pstmt.setString(1, studentname);
         db.pstmt.setInt(2, rollno);
         db.pstmt.setString(3, paymentmode);
         db.pstmt.setString(4, chequeno);
         db.pstmt.setString(5, bankname);
         db.pstmt.setString(6, ddno);
         db.pstmt.setString(7, coursename);
         db.pstmt.setString(8, gstin);
         db.pstmt.setFloat(9, totalamount);
         db.pstmt.setString(10, date);
         db.pstmt.setFloat(11, initialamount);
         db.pstmt.setFloat(12, cgst);
         db.pstmt.setFloat(13, sgst);
         db.pstmt.setString(14, totalinwords);
         db.pstmt.setString(15, remark);
         db.pstmt.setInt(16, year1);
         db.pstmt.setInt(17, year2);
         db.pstmt.setInt(18,receiptno);
  ...
  Color clr1=new Color(0,103,103);
    ...
    public static void main(String args[]) { 
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateFees_Details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateFees_Details().setVisible(true);
            }
        });
    }
