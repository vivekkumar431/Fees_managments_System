...
public class SearchRecord extends javax.swing.JFrame {
   ...
   public void SearchTableRecord(String str){    
   model=(DefaultTableModel)Table_Data.getModel();
   TableRowSorter<DefaultTableModel>  trs=new TableRowSorter<>(model);
  Table_Data.setRowSorter(trs);
   trs.setRowFilter(RowFilter.regexFilter(str));
    ...
    private void initComponents() {
        ...
        getContentPane().add(PanelSideBar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -10, 370, 1010));
        ...
        if (Table_Data.getColumnModel().getColumnCount() > 0) {
            Table_Data.getColumnModel().getColumn(0).setHeaderValue("ReceiptNo");
            Table_Data.getColumnModel().getColumn(1).setHeaderValue("StudentName");
            Table_Data.getColumnModel().getColumn(2).setHeaderValue("RollNo");
            Table_Data.getColumnModel().getColumn(3).setHeaderValue("PaymentMode");
            Table_Data.getColumnModel().getColumn(4).setHeaderValue("CourseName");
            Table_Data.getColumnModel().getColumn(5).setHeaderValue("date");
            Table_Data.getColumnModel().getColumn(6).setHeaderValue("Amount");
            Table_Data.getColumnModel().getColumn(7).setHeaderValue("Remark");
        }
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 100, 260, 40));

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Search Record");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 30, 260, 40));
        ...
        jPanel1.add(txt_Search, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 100, 380, 50));
   ...
   SearchTableRecord(searchString);
